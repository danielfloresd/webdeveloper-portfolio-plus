const PROJECTS = [
  {
    title: "J.A.T.E Web",
    description:
      "J.A.T.E Web is a PWA that offers a simple interface for creating and editing text on any device.",
    tech: "JavaScript/Node.js/Webpack",
    image: "assets/images/jate.jpg",
    url: "https://jate-web.herokuapp.com/",
    github: "https://github.com/danielfloresd/jate-web",
  },
  {
    title: "Tech Blog Space",
    description:
      "Tech Blog Space is a CMS-style blog site where developers can publish their blog posts and comment on other posts.",
    tech: "Handlebars/Node.js",
    image: "assets/images/tech-blog-space.png",
    url: "https://tech-blog-space.herokuapp.com/",
    github: "https://github.com/danielfloresd/tech-blog-space",
  },
  {
    title: "Aptly",
    description:
